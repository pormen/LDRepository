class LogloansController < ApplicationController
  ...
  private
    ...
    def logloan_params
      params.require(:logloan).permit(:rut_solicitante, :nombre_solicitante, :empresa, :obra, :cargo, :monto_solicitado, :numero_coutas, :monto_pagado, :por_pagar, :motivo_solicitud, :comenatrios, :estado)
    end
end
