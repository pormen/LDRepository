...
class AsignarmultiplebeneficiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignarmultiplebeneficio" do
    assert_difference('Asignarmultiplebeneficio.count') do
      post asignarmultiplebeneficios_url, params: { asignarmultiplebeneficio: { areabenefit_id: @asignarmultiplebeneficio.areabenefit_id, benefit_id: @asignarmultiplebeneficio.benefit_id, centrocosto_id: @asignarmultiplebeneficio.centrocosto_id, trabajador_id: @asignarmultiplebeneficio.trabajador_id } }
    end
  ...
  test "should update asignarmultiplebeneficio" do
    patch asignarmultiplebeneficio_url(@asignarmultiplebeneficio), params: { asignarmultiplebeneficio: { areabenefit_id: @asignarmultiplebeneficio.areabenefit_id, benefit_id: @asignarmultiplebeneficio.benefit_id, centrocosto_id: @asignarmultiplebeneficio.centrocosto_id, trabajador_id: @asignarmultiplebeneficio.trabajador_id } }
