class LogasController < ApplicationController
  ...
  private
    ...
    def loga_params
      params.require(:loga).permit(:asocial_id, :user_name, :codigo_obra, :rut_atendido, :nombre_atendido, :apellido_paterno_paterno_atendido, :apellido_materno_atendido, :aspcategory_name, :solucion, :estado, :subcontrato, :supervisor, :descripcion, :rut_pariente, :nombre_pariente, :apellido_paterno_pariente, :apellido_materno_pariente, :parentezco, :empresa, :comentarios_caso, :caso_amerita_epc, :derivar_a, :codigo, :epcformulary_id, :rut_atendido_epc, :codigo_epc, :telefono, :beneficio)
    end
end
