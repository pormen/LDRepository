...
class FamiliartrabajadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create familiartrabajador" do
    assert_difference('Familiartrabajador.count') do
      post familiartrabajadors_url, params: { familiartrabajador: { nombre: @familiartrabajador.nombre, relacion: @familiartrabajador.relacion, rut: @familiartrabajador.rut, trabajador_id: @familiartrabajador.trabajador_id } }
    end
  ...
  test "should update familiartrabajador" do
    patch familiartrabajador_url(@familiartrabajador), params: { familiartrabajador: { nombre: @familiartrabajador.nombre, relacion: @familiartrabajador.relacion, rut: @familiartrabajador.rut, trabajador_id: @familiartrabajador.trabajador_id } }
