class FamiliartrabajadorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @familiartrabajador.save
        format.html { redirect_to @familiartrabajador, notice: 'Familiartrabajador was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to familiartrabajadors_url, notice: 'Familiartrabajador was successfully destroyed.' }
  ...
  private
    ...
    def familiartrabajador_params
      params.require(:familiartrabajador).permit(:rut, :nombre, :relacion, :trabajador_id)
    end
end
