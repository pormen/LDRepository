...
class ObrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create obra" do
    assert_difference('Obra.count') do
      post obras_url, params: { obra: { codigo: @obra.codigo, direccion: @obra.direccion, nombre: @obra.nombre } }
    end
  ...
  test "should update obra" do
    patch obra_url(@obra), params: { obra: { codigo: @obra.codigo, direccion: @obra.direccion, nombre: @obra.nombre } }
